      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
            <div>
              <h1 className="text-3xl font-bold tracking-tight">Tekshiruvlar tarixi</h1>
              <p className="mt-2 text-muted-foreground">O'tgan tekshiruvlaringizni ko'ring va boshqaring</p>
            </div>
