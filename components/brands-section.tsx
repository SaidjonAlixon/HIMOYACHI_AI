        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3 max-w-4xl mx-auto">
          {visibleBrands.map((brand, idx) => (
            <div
              ...
              className={`group relative w-full aspect-[5/2] rounded-xl border border-border/30 bg-card/50 backdrop-blur-sm overflow-hidden transition-all duration-1000 ease-in-out ${
                isAnimating
