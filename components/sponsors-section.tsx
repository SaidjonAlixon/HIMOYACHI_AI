    ...
    <section ref={sectionRef} className="container mx-auto px-4 py-16 md:py-24 bg-background">
      <div className="mx-auto max-w-6xl">
        <div className="mb-12 text-center">
          <h2
            className={`mb-4 text-3xl font-bold tracking-tight md:text-4xl transition-all duration-1000 ${
          ...
          <p
            className={`mx-auto max-w-2xl text-lg text-muted-foreground transition-all duration-1000 delay-200 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
            }`}
          >
