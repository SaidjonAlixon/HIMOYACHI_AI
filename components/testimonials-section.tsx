        ...
        <div className="grid gap-6 md:grid-cols-3">
          {visibleTestimonials.map((testimonial, idx) => (
            <Card
              ...
              className={`border-2 border-[#00ff41] bg-black/40 backdrop-blur-sm hover:shadow-[0_0_28px_rgba(0,255,65,0.2)] transform transition-all duration-1000 ease-in-out ${
                isAnimating
              ...
              <CardContent className="p-6">
                <div className="mb-4 flex items-center gap-1">
                  {[...Array(testimonial.rating)].map((_, i) => (
                    <Star
                      key={i}
                      className={`h-4 w-4 fill-[#00ff41] text-[#00ff41] transition-all duration-700 ${
                ...
                <Quote
                  className={`mb-3 h-6 w-6 text-[#00ff41] opacity-50 transition-all duration-700 ${
            ...
            return (
              <button
                ...
                className={`h-2 rounded-full transition-all duration-500 ease-in-out ${
                  isActive
                    ? "w-8 bg-[#00ff41] shadow-lg shadow-[rgba(0,255,65,0.5)] scale-110"
